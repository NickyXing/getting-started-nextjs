  ...
  return (
    <div>
      ...
      <div className="container p-5 mx-auto">
        <Head>
          <title>
            Fancyimg - Effortlessly Remove Backgrounds, Elevate Your Visuals
          </title>
          <meta
            name="keywords"
            content="remove bg, remove background, erase bg, erase background"
          />
          <meta
            name="description"
            content="Fancyimg's background removal is an online image cutout tool that makes it easy to remove backgrounds with just one click. Simply upload your image, and the software will automatically extract the subject from the background with 100% accuracy, without any additional steps required."
          />
        </Head>
              ...
              >
                ...
                {!loading && (
                  <div>
                    ...
                    Remove Background (will cost 5 credits)
                  </div>
                )}
              </button>
            )}

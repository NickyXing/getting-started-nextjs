        ...
        <section className="pt-5 pb-5 overflow-hidden bg-transparent justify-items-center sm:grid sm:grid-cols-2">
          ...
          <div className="p-8 md:p-12 lg:px-16 lg:py-24">
            <div className="max-w-xl mx-auto text-center ltr:sm:text-center">
              ...
              <p className="hidden text-gray-500 md:mt-4 md:block">
                No Images? AI Text-to-Image is Here. Input your prompts, and our
                advanced AI instantly generates beautiful, custom visuals to
                bring your ideas to life. Transform written concepts into
                stunning imagery that captivates your audience - no design
                skills required.
              </p>

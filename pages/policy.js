  ...
  return (
    <>
      ...
      <div className="px-64 py-20 default-styles">
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              "We", "Us" or "Our" in this Agreement) refers to FancyImg.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to FancyImg, accessible from
              <a
                href="https://fancyimg.com"
        ...
        <ul>
          <li>By email: fancyimg@fancyimg.com</li>
        </ul>
      </div>
    </>
  );
